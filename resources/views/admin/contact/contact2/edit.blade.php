                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            @if ($contact2->icon_address === "ion-ios-bookmarks-outline")
                                <input class="custom-control-input" type="radio" id="address1" name="iconAddress" value="ion-ios-bookmarks-outline" checked>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            @if ($contact2->icon_email === "ion-ios-bookmarks-outline")
                                <input class="custom-control-input" type="radio" id="email1" name="iconEmail" value="ion-ios-bookmarks-outline" checked>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            @if ($contact2->icon_phone === "ion-ios-bookmarks-outline")
                                <input class="custom-control-input" type="radio" id="phone1" name="iconPhone" value="ion-ios-bookmarks-outline" checked>
                            @else
